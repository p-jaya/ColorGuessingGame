...
easyBtn.addEventListener("click", function() {
    ...
    document.querySelector("h1").style.background = "#026161";

    statusText.textContent = "Let's Play!!";

    boxCount = 3;
    this.style.background = "#026161"
    this.style.color = "white"
    hardBtn.style.background = "white";
    hardBtn.style.color = "#026161";
...
function loose(a) {
    console.log(a);
    a.style.background = "rgb(165, 231, 231)"
